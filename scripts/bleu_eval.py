...
# ================= CONFIG =================
INPUT_FILE = "evaluation/logs/gemma_outputs.jsonl"
...
if count == 0:
    ...
    print(f"Average BLEU-1: {sum(bleu1_scores)/count:.4f}")
    print(f"Average BLEU-2: {sum(bleu2_scores)/count:.4f}")
    print(f"Average BLEU-4: {sum(bleu4_scores)/count:.4f}")
